...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        if (authCookie != null)
        {
            ...
            Custom.Security.CustomPrincipalSerializeModel serializeModel = Newtonsoft.Json.JsonConvert.DeserializeObject<Custom.Security.CustomPrincipalSerializeModel>(authTicket.UserData);
           
            if (Request.IsAuthenticated && serializeModel.RoleId == 1)
            {
                return true;
            }
            else
